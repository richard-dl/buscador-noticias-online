...
export const channels = {
  ...
  // ==================== DEPORTES PUBLICOS ====================
  'Deportes Publicos': [
    { id: 'pub-dep-espn-deportes', name: 'ESPN Deportes', url: 'https://e3.thetvapp.to/hls/espn-deportes/index.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/ESPN_Deportes.svg/512px-ESPN_Deportes.svg.png' },
    { id: 'pub-dep-espnu', name: 'ESPN U', url: 'https://fl1.moveonjoy.com/ESPN_U/index.m3u8', logo: 'https://i.imgur.com/HiBrysh.png' },
    { id: 'pub-dep-espnews', name: 'ESPNews', url: 'https://fl1.moveonjoy.com/ESPN_NEWS/index.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/ESPNews.svg/512px-ESPNews.svg.png' },
    { id: 'pub-dep-fox-sports', name: 'Fox Sports MX', url: 'https://ott.udptv.com/stream/udptv/foxsports/master.m3u8?p=eeaf011ae6d8cdbf0200cc0234f54fdc95d7b5b158d22258efd49d7e36275c7a&u=discord.gg/civ3', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/FOX_Sports_logo.svg/512px-FOX_Sports_logo.svg.png' },
    { id: 'pub-dep-fox-deportes', name: 'Fox Deportes', url: 'https://live-manifest.production-public.tubi.io/live/d906efca-1302-4e29-b0d9-9a1d7a305d69/playlist.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/FOX_Deportes_logo.png/512px-FOX_Deportes_logo.png' },
    { id: 'pub-dep-tyc-sports', name: 'TyC Sports', url: 'https://live-04-11-tyc24.vodgc.net/tyc24/index_tyc24_1080.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/TyC_Sports_logo.svg/512px-TyC_Sports_logo.svg.png' },
    { id: 'pub-dep-deportv', name: 'DeporTV', url: 'https://tv.portalexpress.es:3923/live/deportvlive.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Deportv-ar.png' },
    { id: 'pub-dep-directv-sports', name: 'DirecTV Sports', url: 'https://d2dq8p6xzq87wf.cloudfront.net/live/dsports/smil:dsports.smil/playlist.m3u8', logo: 'https://i.imgur.com/0W5A6Ml.png' },
    { id: 'pub-dep-win-sports', name: 'Win Sports', url: 'https://mdstrm.com/live-stream-playlist/6065e3fa41274308e6c1c756.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Win_Sports_logo.svg/250px-Win_Sports_logo.svg.png' },
    { id: 'pub-dep-tdn', name: 'TDN', url: 'https://channel01.akamaized.net/hls/live/2022749/event01/index.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/TUDN_logo.svg/1200px-TUDN_logo.svg.png' },
  ],

  // ==================== CANALES PUBLICOS ADICIONALES ====================
  'Publicos Adicionales Argentina': [
    { id: 'pub-ar-eltrece', name: 'El Trece', url: 'https://live-01-02-eltrece.vodgc.net/eltrecetv/index.m3u8', logo: 'https://i.imgur.com/TrgBAdA.png' },
    { id: 'pub-ar-tn', name: 'TN (Todo Noticias)', url: 'https://dai.google.com/linear/hls/pa/event/5OEEtA9FR-yrvhNE5K8PQQ/stream/c086055a-58d6-4916-a19c-484b8cb1995c:SCL2/master.m3u8', logo: 'https://i.imgur.com/vFwPhPS.png' },
    { id: 'pub-ar-a24', name: 'A24', url: 'https://g5.vxral-slo.transport.edge-access.net/a12/ngrp:a24-100056_all/playlist.m3u8?sense=true', logo: 'https://i.imgur.com/LnXQkIU.png' },
    { id: 'pub-ar-canal9-litoral', name: 'Canal 9 Litoral', url: 'https://stream.arcast.live/ahora/ahora/playlist.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/a/ad/Canal_9_Litoral_2021.png' },
    { id: 'pub-ar-canal9-televida', name: 'Canal 9 Televida', url: 'https://unlimited1-us.dps.live/televidaar/televidaar.smil/playlist.m3u8', logo: 'https://i.imgur.com/JUtAzg4.png' },
    { id: 'pub-ar-canal7-jujuy', name: 'Canal 7 Jujuy', url: 'https://stream.arcast.live/canal7jujuy/ngrp:canal7jujuy_all/playlist.m3u8', logo: 'https://i.imgur.com/K0jk8p4.png' },
    { id: 'pub-ar-canal7-neuquen', name: 'Canal 7 Neuquen', url: 'https://stream.arcast.com.ar/c7nq/ngrp:c7nq_all/playlist.m3u8', logo: 'https://i.ibb.co/BrvQsWm/C7neuquenlogo2023.png' },
    { id: 'pub-ar-canal10-cordoba', name: 'Canal 10 Cordoba', url: 'https://stream.arcast.net:4443/canal10/ngrp:canal10_all/playlist.m3u8', logo: 'https://i.imgur.com/87WCHtd.png' },
    { id: 'pub-ar-bravo-tv', name: 'Bravo TV', url: 'https://redirector.rudo.video/hls-video/c54ac2799874375c81c1672abb700870537c5223/bravo/bravo.smil/playlist.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/Bravotv.png' },
    { id: 'pub-ar-canal34-sj', name: 'Canal 34 San Juan', url: 'https://streamyes.alsolnet.com/canal34hd/live/playlist.m3u8', logo: 'https://i.imgur.com/bZMEiYe.png' },
  ],

  // ==================== INTERNACIONALES PUBLICOS ====================
  'Internacionales Publicos': [
    { id: 'pub-int-dw-espanol', name: 'DW Espanol', url: 'https://dwamdstream102.akamaized.net/hls/live/2015525/dwstream102/index.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Deutsche_Welle_Logo.svg/1200px-Deutsche_Welle_Logo.svg.png' },
    { id: 'pub-int-rt-espanol', name: 'RT en Espanol', url: 'https://rt-esp.rttv.com/dvr/rtesp/playlist.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Russia-today-logo.svg/800px-Russia-today-logo.svg.png' },
    { id: 'pub-int-france24-es', name: 'France 24 Espanol', url: 'https://ythls.armelin.one/channel/UCUdOoVWuWmgo1wByzcsyKDQ.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/France_24_logo_%282018%29.svg/1200px-France_24_logo_%282018%29.svg.png' },
    { id: 'pub-int-euronews-es', name: 'Euronews Espanol', url: 'https://euronews.alteox.app/hls/es/stream.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Euronews_2016_logo.svg/1200px-Euronews_2016_logo.svg.png' },
    { id: 'pub-int-telesur', name: 'Telesur', url: 'https://cdnesmain.telesur.net/HLS/main.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/TeleSUR_logo.svg/1200px-TeleSUR_logo.svg.png' },
    { id: 'pub-int-hispan-tv', name: 'Hispan TV', url: 'https://live.hispantv.ir/media/HispanTV/live/chunklist.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/HispanTV_logo.svg/1200px-HispanTV_logo.svg.png' },
    { id: 'pub-int-nhk-world', name: 'NHK World Japan', url: 'https://nhkwlive-xjp.akamaized.net/hls/live/2003459/nhkwlive-xjp-en/index.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/NHK_World-Japan_Logo.svg/1200px-NHK_World-Japan_Logo.svg.png' },
    { id: 'pub-int-cgtn-es', name: 'CGTN Espanol', url: 'https://news.cgtn.com/resource/live/spanish/cgtn-e.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/CGTN.svg/1200px-CGTN.svg.png' },
    { id: 'pub-int-arirang', name: 'Arirang TV', url: 'https://amdlive.ctnd.com.edgesuite.net/arirang_2ch/smil:arirang_2ch.smil/playlist.m3u8', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Arirang_TV_logo.svg/800px-Arirang_TV_logo.svg.png' },
  ],
  ...
  'Espana': [
    ...
    { id: 'es-bom-cine', name: 'Bom Cine HD', url: `${IPTV_BASE}/609227.ts`, logo: 'https://contenidostv.es/images/bomCine512.png' },
  ],

  // ==================== DEPORTES ====================
  'Deportes': [
    { id: 'dep-tyc-opc1', name: 'TyC Sports', url: `${IPTV_BASE}/573945.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/TyC_Sports_logo.svg/512px-TyC_Sports_logo.svg.png' },
    { id: 'dep-tyc-opc2', name: 'TyC Sports OPC2', url: `${IPTV_BASE}/573946.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/TyC_Sports_logo.svg/512px-TyC_Sports_logo.svg.png' },
    { id: 'dep-dsports-opc1', name: 'DSports', url: `${IPTV_BASE}/673799.ts`, logo: 'https://i.imgur.com/0W5A6Ml.png' },
    { id: 'dep-dsports-opc2', name: 'DSports OPC2', url: `${IPTV_BASE}/573919.ts`, logo: 'https://i.imgur.com/0W5A6Ml.png' },
    { id: 'dep-espn-opc1', name: 'ESPN', url: `${IPTV_BASE}/660606.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/2f/ESPN_logo.png' },
    { id: 'dep-espn-opc2', name: 'ESPN OPC2', url: `${IPTV_BASE}/573893.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/2f/ESPN_logo.png' },
    { id: 'dep-espn2-opc1', name: 'ESPN 2', url: `${IPTV_BASE}/660607.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/ESPN2_logo.svg' },
    { id: 'dep-espn2-opc2', name: 'ESPN 2 OPC2', url: `${IPTV_BASE}/573894.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/ESPN2_logo.svg' },
    { id: 'dep-espn3', name: 'ESPN 3', url: `${IPTV_BASE}/573895.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7a/ESPN3_logo.png' },
    { id: 'dep-espn4', name: 'ESPN 4', url: `${IPTV_BASE}/660608.ts`, logo: 'https://i.imgur.com/BtMnVqt.png' },
    { id: 'dep-espn-premium', name: 'ESPN Premium', url: `${IPTV_BASE}/660609.ts`, logo: 'https://i.imgur.com/nHiO8NM.png' },
    { id: 'dep-fox-sports-opc1', name: 'Fox Sports', url: `${IPTV_BASE}/660612.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/FOX_Sports_logo.svg/512px-FOX_Sports_logo.svg.png' },
    { id: 'dep-fox-sports-opc2', name: 'Fox Sports OPC2', url: `${IPTV_BASE}/573887.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/FOX_Sports_logo.svg/512px-FOX_Sports_logo.svg.png' },
    { id: 'dep-fox-sports2-opc1', name: 'Fox Sports 2', url: `${IPTV_BASE}/660613.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/24/FS2_logo.png' },
    { id: 'dep-fox-sports2-opc2', name: 'Fox Sports 2 OPC2', url: `${IPTV_BASE}/573888.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/24/FS2_logo.png' },
    { id: 'dep-fox-sports3', name: 'Fox Sports 3', url: `${IPTV_BASE}/573889.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Fox_sports_3_logo.svg' },
    { id: 'dep-tnt-sports-opc1', name: 'TNT Sports', url: `${IPTV_BASE}/660617.ts`, logo: 'https://i.ibb.co/6t2GF0m/tntsports.png' },
    { id: 'dep-tnt-sports-opc2', name: 'TNT Sports OPC2', url: `${IPTV_BASE}/573890.ts`, logo: 'https://i.ibb.co/6t2GF0m/tntsports.png' },
    { id: 'dep-deportv-opc1', name: 'DeporTV', url: `${IPTV_BASE}/573918.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Deportv-ar.png' },
    { id: 'dep-deportv-opc2', name: 'DeporTV OPC2', url: `${IPTV_BASE}/634610.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Deportv-ar.png' },
    { id: 'dep-golf-channel', name: 'Golf Channel', url: `${IPTV_BASE}/573891.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Golf_Channel_2014_logo.svg/1200px-Golf_Channel_2014_logo.svg.png' },
    { id: 'dep-star-plus', name: 'Star+', url: `${IPTV_BASE}/660616.ts`, logo: 'https://i.ibb.co/2nV93J9/star-plus.png' },
  ],

  // ==================== INFANTILES ====================
  'Infantiles': [
    { id: 'inf-disney-channel-opc1', name: 'Disney Channel', url: `${IPTV_BASE}/660601.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/3/3d/2022_Disney_Channel_logo.svg' },
    { id: 'inf-disney-channel-opc2', name: 'Disney Channel OPC2', url: `${IPTV_BASE}/573876.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/3/3d/2022_Disney_Channel_logo.svg' },
    { id: 'inf-disney-jr-opc1', name: 'Disney Junior', url: `${IPTV_BASE}/660602.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Disney_Junior_2020.svg' },
    { id: 'inf-disney-jr-opc2', name: 'Disney Junior OPC2', url: `${IPTV_BASE}/573877.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Disney_Junior_2020.svg' },
    { id: 'inf-disney-xd', name: 'Disney XD', url: `${IPTV_BASE}/573878.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/9/96/Disney_XD_Logo.svg' },
    { id: 'inf-cartoon-network-opc1', name: 'Cartoon Network', url: `${IPTV_BASE}/660598.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/8/80/Cartoon_Network_2010_logo.svg' },
    { id: 'inf-cartoon-network-opc2', name: 'Cartoon Network OPC2', url: `${IPTV_BASE}/573873.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/8/80/Cartoon_Network_2010_logo.svg' },
    { id: 'inf-nickelodeon-opc1', name: 'Nickelodeon', url: `${IPTV_BASE}/660604.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/5/53/Nickelodeon_2023_logo_%28outline%29.svg' },
    { id: 'inf-nickelodeon-opc2', name: 'Nickelodeon OPC2', url: `${IPTV_BASE}/573879.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/5/53/Nickelodeon_2023_logo_%28outline%29.svg' },
    { id: 'inf-nick-jr', name: 'Nick Jr', url: `${IPTV_BASE}/573880.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Nick_Jr._logo_2023.svg' },
    { id: 'inf-discovery-kids-opc1', name: 'Discovery Kids', url: `${IPTV_BASE}/660600.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Logo_Discovery_Kids_2024.svg' },
    { id: 'inf-discovery-kids-opc2', name: 'Discovery Kids OPC2', url: `${IPTV_BASE}/573875.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Logo_Discovery_Kids_2024.svg' },
    { id: 'inf-boomerang', name: 'Boomerang', url: `${IPTV_BASE}/573872.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/9/99/Boomerang_2014_logo.svg' },
    { id: 'inf-baby-tv', name: 'Baby TV', url: `${IPTV_BASE}/573871.ts`, logo: 'https://upload.wikimedia.org/wikipedia/en/e/eb/BabyTV_logo.svg' },
    { id: 'inf-pluto-kids', name: 'Pluto TV Kids', url: `${IPTV_BASE}/660605.ts`, logo: 'https://i.imgur.com/8vFZVxK.png' },
  ],

  // ==================== CINE Y SERIES ====================
  'Cine y Series': [
    { id: 'cine-hbo-opc1', name: 'HBO', url: `${IPTV_BASE}/660637.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/d/de/HBO_logo.svg' },
    { id: 'cine-hbo-opc2', name: 'HBO OPC2', url: `${IPTV_BASE}/573858.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/d/de/HBO_logo.svg' },
    { id: 'cine-hbo2', name: 'HBO 2', url: `${IPTV_BASE}/573859.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/2f/HBO_2_logo.svg' },
    { id: 'cine-hbo-family', name: 'HBO Family', url: `${IPTV_BASE}/573860.ts`, logo: 'https://i.imgur.com/mNYYPQV.png' },
    { id: 'cine-hbo-plus', name: 'HBO Plus', url: `${IPTV_BASE}/573861.ts`, logo: 'https://i.imgur.com/X7Qs9vu.png' },
    { id: 'cine-hbo-xtreme', name: 'HBO Xtreme', url: `${IPTV_BASE}/573862.ts`, logo: 'https://i.imgur.com/zvXJpG3.png' },
    { id: 'cine-hbo-mundi', name: 'HBO Mundi', url: `${IPTV_BASE}/573863.ts`, logo: 'https://i.imgur.com/DXLZ7Pd.png' },
    { id: 'cine-hbo-pop', name: 'HBO Pop', url: `${IPTV_BASE}/573864.ts`, logo: 'https://i.imgur.com/u8Z1k4G.png' },
    { id: 'cine-max', name: 'Cinemax', url: `${IPTV_BASE}/573865.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/8/88/Logo_Cinemax.svg' },
    { id: 'cine-star-channel', name: 'Star Channel', url: `${IPTV_BASE}/660646.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/8/89/Star_Channel_2020.svg' },
    { id: 'cine-star-action', name: 'Star Action', url: `${IPTV_BASE}/573867.ts`, logo: 'https://i.imgur.com/X3K9PKR.png' },
    { id: 'cine-star-comedy', name: 'Star Comedy', url: `${IPTV_BASE}/573868.ts`, logo: 'https://i.imgur.com/fMxGqoV.png' },
    { id: 'cine-fx-opc1', name: 'FX', url: `${IPTV_BASE}/660636.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/4/42/FX_logo.svg' },
    { id: 'cine-fx-opc2', name: 'FX OPC2', url: `${IPTV_BASE}/573856.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/4/42/FX_logo.svg' },
    { id: 'cine-space', name: 'Space', url: `${IPTV_BASE}/573869.ts`, logo: 'https://i.imgur.com/JKuLRNT.png' },
    { id: 'cine-tnt-opc1', name: 'TNT', url: `${IPTV_BASE}/660648.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/24/TNT_Logo_2016.svg' },
    { id: 'cine-tnt-opc2', name: 'TNT OPC2', url: `${IPTV_BASE}/573855.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/24/TNT_Logo_2016.svg' },
    { id: 'cine-tnt-series', name: 'TNT Series', url: `${IPTV_BASE}/573870.ts`, logo: 'https://i.imgur.com/GBc7vGK.png' },
    { id: 'cine-warner', name: 'Warner Channel', url: `${IPTV_BASE}/660649.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/6/6a/Warner_Channel_logo.svg' },
    { id: 'cine-universal', name: 'Universal TV', url: `${IPTV_BASE}/573854.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Universal_TV_2018.svg' },
    { id: 'cine-axn', name: 'AXN', url: `${IPTV_BASE}/573851.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e9/AXN_logo_2016.svg' },
    { id: 'cine-sony', name: 'Sony Channel', url: `${IPTV_BASE}/573852.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Sony_logo.svg' },
    { id: 'cine-paramount', name: 'Paramount Channel', url: `${IPTV_BASE}/573853.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/a/ab/Paramount_Network.svg' },
    { id: 'cine-amc', name: 'AMC', url: `${IPTV_BASE}/573850.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/2d/AMC_logo.svg' },
  ],

  // ==================== DOCUMENTALES ====================
  'Documentales': [
    { id: 'doc-discovery-opc1', name: 'Discovery Channel', url: `${IPTV_BASE}/660631.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/5/5c/Discovery_Channel_logo_2019.svg' },
    { id: 'doc-discovery-opc2', name: 'Discovery OPC2', url: `${IPTV_BASE}/573841.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/5/5c/Discovery_Channel_logo_2019.svg' },
    { id: 'doc-natgeo-opc1', name: 'National Geographic', url: `${IPTV_BASE}/660642.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fc/Natgeologo.svg' },
    { id: 'doc-natgeo-opc2', name: 'NatGeo OPC2', url: `${IPTV_BASE}/573844.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fc/Natgeologo.svg' },
    { id: 'doc-natgeo-wild', name: 'NatGeo Wild', url: `${IPTV_BASE}/573845.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Nat_Geo_Wild_logo.svg' },
    { id: 'doc-history-opc1', name: 'History Channel', url: `${IPTV_BASE}/660638.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f5/History_Logo.svg' },
    { id: 'doc-history-opc2', name: 'History OPC2', url: `${IPTV_BASE}/573842.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f5/History_Logo.svg' },
    { id: 'doc-history2', name: 'History 2', url: `${IPTV_BASE}/573843.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e5/H2_%28TV_channel%29_logo.svg' },
    { id: 'doc-animal-planet-opc1', name: 'Animal Planet', url: `${IPTV_BASE}/660628.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Animal_Planet_logo_2018.svg' },
    { id: 'doc-animal-planet-opc2', name: 'Animal Planet OPC2', url: `${IPTV_BASE}/573840.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Animal_Planet_logo_2018.svg' },
    { id: 'doc-discovery-science', name: 'Discovery Science', url: `${IPTV_BASE}/573846.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/0/0d/Discovery_Science_2017_logo.svg' },
    { id: 'doc-discovery-turbo', name: 'Discovery Turbo', url: `${IPTV_BASE}/573847.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Logo_Discovery_Turbo.svg' },
    { id: 'doc-discovery-theater', name: 'Discovery Theater', url: `${IPTV_BASE}/573848.ts`, logo: 'https://i.imgur.com/9gDQBqW.png' },
    { id: 'doc-tlc', name: 'TLC', url: `${IPTV_BASE}/573849.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/2/22/TLC_Logo.svg' },
    { id: 'doc-food-network', name: 'Food Network', url: `${IPTV_BASE}/660635.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f9/Food_Network_logo_2021.svg' },
  ],

  // ==================== MUSICA ====================
  'Musica': [
    { id: 'mus-mtv-opc1', name: 'MTV', url: `${IPTV_BASE}/660641.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/6/68/MTV_2021_%28brand_version%29.svg' },
    { id: 'mus-mtv-opc2', name: 'MTV OPC2', url: `${IPTV_BASE}/573832.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/6/68/MTV_2021_%28brand_version%29.svg' },
    { id: 'mus-mtv-hits', name: 'MTV Hits', url: `${IPTV_BASE}/573833.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/d/db/MTV_Hits_Logo.svg' },
    { id: 'mus-mtv-live', name: 'MTV Live', url: `${IPTV_BASE}/573834.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/3/31/MTV_Live_HD.svg' },
    { id: 'mus-vh1-opc1', name: 'VH1', url: `${IPTV_BASE}/660650.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/b/b5/VH1_logonew.svg' },
    { id: 'mus-vh1-opc2', name: 'VH1 OPC2', url: `${IPTV_BASE}/573835.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/b/b5/VH1_logonew.svg' },
    { id: 'mus-htvmusic', name: 'HTV Music', url: `${IPTV_BASE}/573836.ts`, logo: 'https://i.imgur.com/VQZFqTz.png' },
    { id: 'mus-quiero-music', name: 'Quiero Music', url: `${IPTV_BASE}/573837.ts`, logo: 'https://i.imgur.com/Y3xWJNn.png' },
    { id: 'mus-telehit', name: 'Telehit', url: `${IPTV_BASE}/573838.ts`, logo: 'https://upload.wikimedia.org/wikipedia/commons/e/ed/Telehit_2016_logo.svg' },
    { id: 'mus-cm-musica', name: 'CM (Cielo Musica)', url: `${IPTV_BASE}/573839.ts`, logo: 'https://i.imgur.com/RGJZNZT.png' },
  ],
};
